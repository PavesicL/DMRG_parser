...
saved_sets, saved = save_variables_simple(f"get_quadrupole_moments_{i}_{j}", "get_quadrupole_moments", [i, j])

if saved!=0:
	print("Saved {} quadrupole moments in {} sets.".format(saved, saved_sets))
